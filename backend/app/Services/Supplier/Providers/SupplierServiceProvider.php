...
class SupplierServiceProvider extends ServiceProvider
{
     ...
     *
     * Previous usage:
     * php artisan migrate --path=src/Services/Supplier/database/migrations
     * Now:
     * php artisan migrate
     *
     * @return void
    ...
    /**
    * Register the Supplier service provider.
    *
    * @return void
    */
    ...
    /**
     * Register the Supplier service resource namespaces.
     *
     * @return void
     */
